    ...
    public static void main(String[] args) {
        ...
        try (MongoClient mongoClient = MongoClients.create(connectionString)) {
            ...
            clients.append("nom", "Client1")
                    ...
                    .append("Codi Postal","08210")
                    .append("Localitat","idLocalitat1")
                    .append("Provincia","idProvincia1")
                    .append("Numero de Telefon","1312312332");
            ...
            Date date = (Date)formatter.parse("05-05-2022 18:21:44");
            Date date2 = (Date)formatter.parse("05-05-2023 18:35:12");
            ...
            empleatsd.append("nom", "Empleat1")
                    ...
                    .append("NIF","1212121212")
                    .append("Numero de Telefon","121212121")
